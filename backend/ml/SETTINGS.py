...
Пример формата JSON:
{
  "criterions": [
    {
      "rate: "оценка",
      "description": "объяснение поставленной оценки"
    }
  ],
  "career_growth": "Тип: строка, предполагаемый карьерный рост"
}
